...
const Examination = ({ onFullscreenChange, onModalStateChange }) => {
  ...
  useEffect(() => {
    const hasModal = isAddScholarModalOpen || isEditModalOpen || showFilterModal || 
                    ...
                    showForwardAllModal || showDeleteAllModal;
    if (onModalStateChange) {
      onModalStateChange(hasModal);
    }
  }, [isAddScholarModalOpen, isEditModalOpen, showFilterModal, showUploadModal, 
      showVerifyModal, showForwardModal, showForwardAllModal, showDeleteAllModal, onModalStateChange]);
