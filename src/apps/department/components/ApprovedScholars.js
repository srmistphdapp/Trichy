									...
									filtered.map((s, idx) => {
										...
										return (
											<tr key={s.id} className="hover:bg-blue-50/30 transition-colors group">
												...
												<td className="px-5 py-4 text-gray-900 border-r border-gray-100">{s.faculty || 'SRM Institute of Science and Technology'}</td>
												<td className="px-5 py-4 text-gray-900 border-r border-gray-100" title={s.program || s.specialization}>{cleanProgramName(s.program || s.specialization)}</td>
