						...
						<table className="w-full min-w-[1800px] border-collapse bg-white text-sm text-left table-fixed">
							<thead className="bg-slate-50 sticky top-0 z-10 shadow-sm">
								<tr>
									...
									<th className="px-5 py-4 font-bold text-gray-700 uppercase text-xs tracking-wider border-b border-gray-200 border-r border-gray-100 w-[280px]">SELECT PROGRAM</th>
									...
									filtered.map((s, idx) => {
										...
										return (
											<tr key={s.id} className="hover:bg-blue-50/30 transition-colors group">
												...
												<td className="px-5 py-4 whitespace-nowrap text-gray-900 border-r border-gray-100">{s.faculty || 'SRM Institute of Science and Technology'}</td>
												<td className="px-5 py-4 whitespace-nowrap text-gray-900 border-r border-gray-100" title={s.program || s.specialization}>{cleanProgramName(s.program || s.specialization)}</td>
